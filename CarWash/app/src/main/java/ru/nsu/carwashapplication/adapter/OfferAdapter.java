package ru.nsu.carwashapplication.adapter;
...
import ru.nsu.carwashapplication.OfferPage;

import ru.nsu.carwashapplication.R;
...
public class OfferAdapter extends RecyclerView.Adapter<OfferAdapter.OfferViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OfferViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            intent.putExtra("offerBtnColor", Color.parseColor(offers.get(position).getBtnColor()));
